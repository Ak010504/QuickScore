...
class _PlState extends State<Pl> {
  _PlState() {
    ...
    fetch_fixtures(
        formattedDate); // Fetch fixtures data when the widget is initialized
  }
  ViewType _currentVScaiew = ViewType.fixtures;
  ...
  void fetch_fixtures(String formatteddate) async {
    try {
      ...
      var response = await get(Uri.parse(
          'https://apiv3.apifootball.com/?action=get_events&from=$formatteddate&to=$afterdays&timezone=Asia/Kolkata&league_id=152&APIkey=3870e010c2bed663559a9ccdafa432032e4c9b4e5961b55f7911190591e53149'));
  ...
  void fetch_result(String formatteddate) async {
    ...
    try {
      var response = await get(Uri.parse(
          'https://apiv3.apifootball.com/?action=get_events&from=$afterdays&to=$formatteddate&timezone=Asia/Kolkata&league_id=152&APIkey=3870e010c2bed663559a9ccdafa432032e4c9b4e5961b55f7911190591e53149'));
      List data = jsonDecode(response.body);
              ...
              child: OutlinedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        children: [Text(timeList[index]), Text(dates[index])],
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        Image.asset('assets/pltrans2.png', width: 100, height: 100),
        const SizedBox(height: 50),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
